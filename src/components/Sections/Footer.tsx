...
const Footer: FC = memo(() => (
  <div className="relative footer bg-fixed bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pb-8 sm:pt-14">
    ...
    <div className="flex flex-col items-center gap-y-6">
      ...
      <span className="text-sm text-700">© Copyright {currentYear} Sidney Hackney</span>
    </div>
  </div>
));
